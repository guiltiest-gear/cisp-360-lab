...
// share.  She must pay her stockbroker a 2
//              percent commission for the transaction.  Write a program that
...
constexpr int commission_price(int x) { return x * commission; }
