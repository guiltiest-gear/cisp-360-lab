...
// Description: Dynamically allocate an array large enough to hold a user
// defined number of test scores. Once all
//              the scores are entered, the array should be passed to a function
//              that sorts them in ascening order, another to calculate the
//              average score. Display the sorted list and average with the
//              correct heading. *Use pointer notation whenever possible.*
#include <iostream>
...
// Selection sort, about as you expect, but converted for use with manual
// pointer arrays
void selection_sort(int *arr, int n) {
...
void user_input() {
  ...
  // HACK: I know vectors exist, I know, but the point is to learn how pointers
  // work
...
int main() {
  ...
  // NOTE: DO NOT FORGET TO DELETE THE ARRAY, DO NOT LEAVE THIS LINE OUT OR YOU
  // WILL REGRET IT,
