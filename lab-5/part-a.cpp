...
// Description: Create two identical arrays of 8 integers. Display the contents
// of the first array, then sort with
//              ascending order bubble sort and print after each pass of the
//              sort. Display the contents of the second array, then sort with
//              ascending order selection sort and print after each pass of the
//              sort.
#include <iostream>
...
int main() {
  ...
  /*
   * NOTE: I have no clue if I could just do something like
   * selection_sort_arr[length] = bubble_sort_arr[length] to save on a single
   * line of code, but that at that point, it's just splitting hairs, good
   * enough for me
   */
