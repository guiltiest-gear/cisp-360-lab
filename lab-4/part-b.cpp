...
// Description: Write a program that has an array of at least 20 integers. Call
// a function that uses a linear search
//              algorithm to locate one of the values. Keep a count of the
//              number of comparisons it makes until it finds the value. Do the
//              same exact thing with a binary search algorithm. Display the
//              values on screen.
...
// I have no idea why, but clangd won't shut up about it when I call
// linear_search
...
int main() {
  ...
  cout << "Linear search found number after " << linear_counter
       << " comparisons.\n";
  cout << "Binary search found number after " << binary_counter
       << " comparisons.\n";
  return 0;
}
