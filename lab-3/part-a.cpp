...
// Description: Write a program that opens the file Random.txt, reads all of the
// numbers from the file, and calculates
//              the following:
...
int main() {
  ...
  cout << "The amount of numbers in the file is " << counter - 1
       << '\n'; // I need to subtract 1 because it seems to count the newline at
                // the end of the file
  cout << "The sum of all the numbers in the file is " << sum << '\n';
  cout << "The average of all the numbers in the file is "
       << static_cast<float>(sum) / static_cast<float>(counter) << '\n';
