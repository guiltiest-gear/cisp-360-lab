...
// Description: Write a program that asks the uter to enter todays sales for
// fvie stores. The program should then
//              display a bar graph comparing each store's sales. Create each
//              par in the graph by displaying a row of asterisks. Each asterisk
//              should represent $100 of slaes.
